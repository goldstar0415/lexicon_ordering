Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'staging.lexiconresourcesonline.com' }
...
Rails.application.routes.default_url_options[:host] = 'staging.lexiconresourcesonline.com'